...
function callinghim(){
    ...
    const symbol=document.getElementById("symbolNo").value;
    // console.log(symbol);
    document.getElementById("endof").style.display= 'none';
      ...
      callingforgrade("AARATI TIMILSINA",12401,"","TWELVE","biology",39,25,40,25,33,21,40,21,20,19,20,21);
        break;
                ...
                case "12403":
                  ...
                  case "12404":
                     callingforgrade("ANSHU SILWAL",12404,"","TWELVE","biology",68,25,68,25,68,25,68,25,68,25,68,25);
                     break;       
